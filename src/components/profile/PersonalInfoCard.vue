  ...
  <div>
        ...
        <div class="w-full">
          ...
          <div class="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-7 2xl:gap-x-32">
            ...
            <div class="col-span-2">
              ...
              <p class="text-sm font-medium text-gray-800 dark:text-white/90">{{ profileRole }}</p>
            </div>
          </div>
        </div>

        <button class="edit-button flex-shrink-0 mt-4 lg:mt-0" @click="isProfileInfoModal = true">
    ...
    <Modal v-if="isProfileInfoModal" @close="isProfileInfoModal = false">
      <div class="no-scrollbar relative w-full max-w-[700px] overflow-y-auto rounded-3xl bg-white p-4 dark:bg-gray-900 lg:p-11">
        ...
        <button @click="isProfileInfoModal = false" class="transition-color absolute right-5 top-5 z-999 flex h-11 w-11 items-center justify-center rounded-full bg-gray-100 text-gray-400 hover:bg-gray-200 hover:text-gray-600 dark:bg-white/[0.05] dark:text-gray-400 dark:hover:bg-white/[0.07] dark:hover:text-gray-300">
        ...
        <div class="px-2 pr-14 mb-6">
          ...
          <p class="text-sm text-gray-500 dark:text-gray-400">
            Pembaruan profil membutuhkan endpoint backend khusus yang saat ini belum tersedia.
          </p>
        </div>
          ...
          <div class="custom-scrollbar overflow-y-auto p-2">
            <div class="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
              ...
              <div class="col-span-2 lg:col-span-1">
                ...
                <input type="text" :value="profileName" disabled class="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300 bg-gray-50 px-4 py-2.5 text-sm text-gray-500 cursor-not-allowed dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400" />
              </div>

              <div class="col-span-2 lg:col-span-1">
                <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">Username</label>
                <input type="text" :value="profileUsername" disabled class="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300 bg-gray-50 px-4 py-2.5 text-sm text-gray-500 cursor-not-allowed dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400" />
              </div>
              ...
              <div class="col-span-2 lg:col-span-1">
                ...
                <input type="password" placeholder="Masukkan password baru" class="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs focus:border-brand-300 focus:outline-none focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:text-white/90 dark:focus:border-brand-800" />
              </div>

            </div>
          </div>

          <div class="flex items-center gap-3 px-2 mt-8 justify-end">
...
const saveProfile = () => {
  alert('Saat ini data hanya dummy. Dibutuhkan endpoint backend khusus untuk menyimpan edit profil dan ganti password.')
