        ...
        <table class="min-w-full">
          ...
          <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
            ...
            <tr v-else-if="dosenList.length === 0">
              <td colspan="8" class="px-5 py-8 text-center text-gray-500 text-theme-sm">Belum ada data dosen.</td>
            </tr>
            <tr v-else v-for="(item, index) in dosenList" :key="item.id"
              ...
              <td class="px-5 py-4 text-center sm:px-6">
                <span class="inline-flex items-center justify-center rounded-full bg-purple-100 px-3 py-1 text-xs font-medium text-purple-800">
                  {{ item.grup_riset || '-' }}
                </span>
              </td>
              <td class="px-5 py-4 text-center sm:px-6">
              ...
              <td class="px-5 py-4 text-center sm:px-6">
                <div class="flex items-center justify-center gap-2">
                  <button @click="openEditModal(item)"
                    class="flex items-center gap-2 px-3 py-1.5 text-sm font-medium text-gray-700 transition-colors bg-white border border-gray-200 rounded-full hover:bg-gray-50 hover:text-blue-600 shadow-theme-xs" title="Edit">
                  ...
                  <button @click="openDeleteModal(item)"
                    class="flex items-center gap-2 px-3 py-1.5 text-sm font-medium text-gray-700 transition-colors bg-white border border-gray-200 rounded-full hover:bg-gray-50 hover:text-red-600 shadow-theme-xs" title="Hapus">
...
// Tipe khusus untuk Alert agar ESLint TypeScript tidak protes
