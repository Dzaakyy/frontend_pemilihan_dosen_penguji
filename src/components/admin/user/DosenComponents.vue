        ...
        <table class="min-w-full">
          <thead>
            <tr class="border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-white/[0.02]">
              ...
              <th class="px-5 py-3 text-center sm:px-6">
                <p class="font-medium text-gray-500 text-theme-xs dark:text-gray-400">Kuota</p>
              </th>
              <th v-if="isAdmin" class="px-5 py-3 text-center w-40 sm:px-6">
              ...
              <td v-if="isAdmin" class="px-5 py-4 text-center sm:px-6">
                <div class="flex items-center justify-center gap-1.5">
                  <button @click="openDetailModal(item)"
                    class="flex items-center justify-center w-8 h-8 text-emerald-600 bg-emerald-50 border border-emerald-200 rounded-full hover:bg-emerald-100 transition-colors dark:bg-gray-800 dark:text-emerald-400 dark:border-gray-700 dark:hover:bg-gray-700"
                    title="Detail Dosen">
                  ...
                  <button @click="openEditModal(item)"
                    class="flex items-center justify-center w-8 h-8 text-blue-600 bg-blue-50 border border-blue-200 rounded-full hover:bg-blue-100 transition-colors dark:bg-gray-800 dark:text-blue-400 dark:border-gray-700 dark:hover:bg-gray-700"
                    title="Edit">
                  ...
                  <button @click="openDeleteModal(item)"
                    class="flex items-center justify-center w-8 h-8 text-red-600 bg-red-50 border border-red-200 rounded-full hover:bg-red-100 transition-colors dark:bg-gray-800 dark:text-red-400 dark:border-gray-700 dark:hover:bg-gray-700"
                    title="Hapus">
