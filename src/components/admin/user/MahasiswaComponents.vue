<template>
  <div class="relative">
    ...
    <Modal v-if="isDetailModalOpen" @close="closeDetailModal">
      <div class="relative w-full max-w-[700px] rounded-3xl bg-white p-6 dark:bg-gray-900 border dark:border-gray-700 lg:p-11 mx-auto mt-10 shadow-2xl transition-colors">
        <button @click="closeDetailModal" class="absolute right-5 top-5 z-[100] flex h-11 w-11 items-center justify-center rounded-full bg-gray-100 text-gray-400 hover:bg-gray-200 dark:bg-white/[0.05] dark:hover:bg-white/[0.07] dark:text-gray-400 dark:hover:text-gray-300 transition-colors">
          <svg class="fill-current w-6 h-6" viewBox="0 0 24 24"><path fill-rule="evenodd" clip-rule="evenodd" d="M6.04289 16.5418C5.65237 16.9323 5.65237 17.5655 6.04289 17.956C6.43342 18.3465 7.06658 18.3465 7.45711 17.956L11.9987 13.4144L16.5408 17.9565C16.9313 18.347 17.5645 18.347 17.955 17.9565C18.3455 17.566 18.3455 16.9328 17.955 16.5423L13.4129 12.0002L17.955 7.45808C18.3455 7.06756 18.3455 6.43439 17.955 6.04387C17.5645 5.65335 16.9313 5.65335 16.5408 6.04387L11.9987 10.586L7.45711 6.04439C7.06658 5.65386 6.43342 5.65386 6.04289 6.04439C5.65237 6.43491 5.65237 7.06808 6.04289 7.4586L10.5845 12.0002L6.04289 16.5418Z" /></svg>
        </button>
        ...
        <div class="flex flex-col gap-6" v-if="selectedMahasiswaDetail">
          ...
          <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
            <div class="flex flex-col p-4 bg-gray-50 rounded-xl border border-gray-100 dark:bg-gray-800/50 dark:border-gray-800">
              <span class="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-1">Nama Lengkap</span>
              <span class="text-[15px] font-bold text-gray-800 dark:text-gray-200">{{ selectedMahasiswaDetail.nama_mahasiswa }}</span>
            </div>

            <div class="flex flex-col p-4 bg-gray-50 rounded-xl border border-gray-100 dark:bg-gray-800/50 dark:border-gray-800">
              <span class="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-1">Nomor Induk (NIM)</span>
              <span class="text-[15px] font-bold text-gray-800 dark:text-gray-200">{{ selectedMahasiswaDetail.nim }}</span>
            </div>
          </div>
          ...
          <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 border-t border-gray-100 pt-6 dark:border-gray-800">
            <div class="flex flex-col">
              ...
              <span class="text-sm font-medium text-gray-700 dark:text-gray-300">{{ selectedMahasiswaDetail.prodi?.nama_prodi || '-' }}</span>
            </div>
            <div class="flex flex-col">
              <span class="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-1">Topik Tugas Akhir</span>
              <span class="inline-flex w-max items-center justify-center rounded-md bg-brand-50 px-2.5 py-1 text-xs font-semibold text-brand-700 border border-brand-100 dark:bg-brand-900/30 dark:text-brand-300 dark:border-brand-800">
          ...
          <div class="grid grid-cols-1 border-t border-gray-100 pt-6 dark:border-gray-800">
            <div class="flex flex-col">
              <span class="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-1">Akun Pengguna (Username)</span>
              <span class="text-sm font-medium text-gray-700 dark:text-gray-300">{{ selectedMahasiswaDetail.user?.username || '-' }}</span>
            </div>
          </div>
    ...
    <Modal v-if="isModalOpen" @close="closeModal">
      <div class="relative w-full max-w-[700px] flex flex-col max-h-[90vh] rounded-2xl bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 mx-auto mt-10 shadow-2xl overflow-hidden transition-colors">
            ...
            <div>
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-5 gap-y-4">
                <div>
                  ...
                  <input v-model="formData.nama_mahasiswa" type="text" placeholder="Misal: Anton Surya" class="h-10 w-full rounded-lg border border-gray-300 bg-transparent px-3 py-2 text-sm text-gray-800 shadow-theme-xs focus:border-brand-300 focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200 transition-colors" required />
                </div>
                <div>
                  <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">NIM <span class="text-red-500">*</span></label>
                  <input v-model="formData.nim" type="text" placeholder="Masukkan NIM" class="h-10 w-full rounded-lg border border-gray-300 bg-transparent px-3 py-2 text-sm text-gray-800 shadow-theme-xs focus:border-brand-300 focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200 transition-colors" required />
                </div>
                ...
                <div class="sm:col-span-2">
                  ...
                  <input v-model="formData.judul_ta" type="text" placeholder="Judul TA Mahasiswa" class="h-10 w-full rounded-lg border border-gray-300 bg-transparent px-3 py-2 text-sm text-gray-800 shadow-theme-xs focus:border-brand-300 focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200 transition-colors" />
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-5 gap-y-4">
                <div>
                  ...
                  <input v-model="formData.username" type="text" placeholder="Username untuk mahasiswa" class="h-10 w-full rounded-lg border border-gray-300 bg-transparent px-3 py-2 text-sm text-gray-800 shadow-theme-xs focus:border-brand-300 focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200 transition-colors" :required="!isEditing" />
                </div>
                <div>
                  ...
                  <input v-model="formData.password" type="password" placeholder="Password untuk mahasiswa" class="h-10 w-full rounded-lg border border-gray-300 bg-transparent px-3 py-2 text-sm text-gray-800 shadow-theme-xs focus:border-brand-300 focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200 transition-colors" :required="!isEditing" />
        ...
        <div class="px-6 py-4 border-t border-gray-100 dark:border-gray-800 bg-gray-50 dark:bg-gray-900/50 flex justify-end gap-3 z-10 rounded-b-2xl">
          ...
          <button type="submit" form="mahasiswaForm" :disabled="isSaving || formData.prodi_id === ''" class="px-5 py-2.5 text-sm font-medium text-white bg-brand-500 rounded-lg hover:bg-brand-600 shadow-theme-xs disabled:opacity-50 transition-colors dark:bg-brand-600 dark:hover:bg-brand-500">
