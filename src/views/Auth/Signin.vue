        ...
        <div class="flex flex-col flex-1 w-full lg:w-1/2">
          ...
          <div class="flex flex-col justify-center flex-1 w-full max-w-md mx-auto">
            <div>
              ...
              <div>
                <div v-if="errorMessage" class="p-3 mb-4 text-sm text-red-700 bg-red-100 rounded-lg dark:bg-red-900/30 dark:text-red-400">
                  {{ errorMessage }}
                </div>
...
const handleSubmit = async () => {
  ...
  try {
    ...
    if (response.ok && result.success) {
      // Jika berhasil login, redirect ke halaman dashboard (/ecommerce)
